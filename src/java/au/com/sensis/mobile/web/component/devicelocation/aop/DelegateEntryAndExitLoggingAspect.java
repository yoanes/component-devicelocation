package au.com.sensis.mobile.web.component.devicelocation.aop;
...
public class DelegateEntryAndExitLoggingAspect
     ...
     */
    @Pointcut("bean(devicelocation.*Delegate)")
    protected final void devicelocationDelegate() { }
